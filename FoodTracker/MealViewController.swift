...
class MealViewController: UIViewController, UITextFieldDelegate,
    ...
    override func viewDidLoad() {
        ...
        // Enable Save Button if text field has text
    ...
    @IBAction func cancel(_ sender: UIBarButtonItem) {
        ...
        else { fatalError("The MealViewController is not inside a navigation contorller...") }
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        guard let button = sender as? UIBarButtonItem, button === saveButton else{
            os_log("it wasn't the save button...cancel", log: OSLog.default, type: .debug)
            return
        }
        ...
        // instantiate the meal to be passed to MealTableViewController after the unwind seque
